...
var Ae = J(/Edge/i);
var wt = J(/firefox/i);
var Se = J(/safari/i) && !J(/chrome/i) && !J(/android/i);
  ...
  return {
    ...
    animateAll: function(o) {
      ...
      t.forEach(function(l) {
        var s = 0, u = l.target, d = u.fromRect, c = N(u), m = u.prevFromRect, y = u.prevToRect, v = l.rect, E = ge(u, true);
...
function Pn(t) {
  ...
  if (e = e || n && n[W], !!e) {
    ...
    window.CustomEvent && !Q && !Ae ? E = new CustomEvent(o, {
      bubbles: true,
      cancelable: true
    }) : (E = document.createEvent("Event"), E.initEvent(o, true, true)), E.to = a || n, E.from = l || n, E.item = r || n, E.clone = i, E.oldIndex = s, E.newIndex = u, E.oldDraggableIndex = d, E.newDraggableIndex = c, E.originalEvent = m, E.pullMode = y ? y.lastPutMode : void 0;
...
function p(t, e) {
  ...
  var n = {
    ...
    supportPointer: p.supportPointer !== false && "PointerEvent" in window && !Se,
...
p.prototype = /** @lends Sortable.prototype */
{
  ...
  _onTapStart: function(e) {
    if (e.cancelable) {
      ...
      if (jn(o), !f && !(/mousedown|pointerdown/.test(a) && e.button !== 0 || r.disabled) && !u.isContentEditable && !(!this.nativeDraggable && Se && s && s.tagName.toUpperCase() === "SELECT") && (s = V(s, r.draggable, o, false), !(s && s.animated) && Ye !== s)) {
  ...
  _prepareDragStart: function(e, n, o) {
    ...
    if (o && !f && o.parentNode === i) {
      ...
      if (D = i, f = o, C = f.parentNode, fe = f.nextSibling, Ye = o, xe = a.group, p.dragged = f, se = {
        ...
        r._disableDelayedDragEvents(), !wt && r.nativeDraggable && (f.draggable = true), r._triggerDragStart(e, n), R({
          sortable: r,
          name: "choose",
          originalEvent: e
        ...
        Rt(f, d.trim(), et);
      }), _(l, "dragover", ue), _(l, "mousemove", ue), _(l, "touchmove", ue), _(l, "mouseup", r._onDrop), _(l, "touchend", r._onDrop), _(l, "touchcancel", r._onDrop), wt && this.nativeDraggable && (this.options.touchStartThreshold = 4, f.draggable = true), H("delayStart", this, {
        evt: e
  ...
  _onDragStart: function(e, n) {
    ...
    }), !n && L(f, i.dragClass, true), n ? (Ge = true, o._loopId = setInterval(o._emulateDragOver, 50)) : (w(document, "mouseup", o._onDrop), w(document, "touchend", o._onDrop), w(document, "touchcancel", o._onDrop), r && (r.effectAllowed = "move", i.setData && i.setData.call(o, r, f)), _(document, "drop", o), h2(f, "transform", "translateZ(0)")), he = true, o._dragStartId = Be(o._dragStarted.bind(o, n, e)), _(document, "selectstart", o), Ee = true, Se && h2(document.body, "user-select", "none");
  },
  // Returns true - if no further action is needed (either inserted or another condition)
  _onDragOver: function(e) {
    var n = this.el, o = e.target, r, i, a, l = this.options, s = l.group, u = p.active, d = xe === s, c = l.sort, m = x || u, y, v = this, E = false;
    if (it)
      return;
    function T(ye, Ut) {
      H(ye, v, q({
    ...
    function P(ye) {
      ...
      }), v !== m && (m.animateAll(), m._ignoreWhileAnimating = null)), (o === f && !f.animated || o === n && !o.animated) && (de = null), !l.dragoverBubble && !e.rootEl && o !== document && (f.parentNode[W]._isOutsideThisEl(e.target), !ye && ue(e)), !l.dragoverBubble && e.stopPropagation && e.stopPropagation(), E = true;
    }
    function Y() {
    ...
    if (f.contains(e.target) || o.animated && o.animatingX && o.animatingY || v._ignoreWhileAnimating === o)
      return P(false);
    if (Ge = false, u && !l.disabled && (d ? c || (a = C !== D) : x === this || (this.lastPutMode = xe.checkPull(this, u, f, e)) && s.checkPut(this, u, f, e))) {
      if (y = this._getDirection(e, o) === "vertical", r = N(f), T("dragOverValid"), p.eventCanceled)
        return E;
      if (a)
        return C = D, X(), this._hideClone(), T("revert"), p.eventCanceled || (fe ? D.insertBefore(f, fe) : D.appendChild(f)), P(true);
      var M = ct(n, l.draggable);
      if (!M || Hn(e, y, this) && !M.animated) {
        if (M === f)
          return P(false);
        if (M && n === e.target && (o = M), o && (i = N(o)), Re(D, n, f, r, o, i, e, !!o) !== false)
          return X(), M && M.nextSibling ? n.insertBefore(f, M.nextSibling) : n.appendChild(f), C = n, Y(), P(true);
      } else if (M && Bn(e, y, this)) {
        var b = me(n, 0, l, true);
        if (b === f)
          return P(false);
        if (o = b, i = N(o), Re(D, n, f, r, o, i, e, false) !== false)
          return X(), n.insertBefore(f, b), C = n, Y(), P(true);
        ...
        de !== o && (k = i[ie], Ce = false, Me = !A && l.invertSwap || B), S = Ln(e, o, i, y, A ? 1 : l.swapThreshold, l.invertedSwapThreshold == null ? l.swapThreshold : l.invertedSwapThreshold, Me, de === o);
        var K;
        if (S !== 0) {
          var ae = j(f);
          do
        ...
        if (Ne !== false)
          return (Ne === 1 || Ne === -1) && (te = Ne === 1), it = true, setTimeout(kn, 30), X(), te && !be ? n.appendChild(f) : o.parentNode.insertBefore(f, te ? be : o), ee && Yt(ee, 0, ve - ee.scrollTop), C = f.parentNode, k !== void 0 && !Me && (ke = Math.abs(k - N(o)[ie])), Y(), P(true);
      }
      if (n.contains(f))
        return P(false);
    }
  ...
  toArray: function() {
    for (var e = [], n, o = this.el.children, r = 0, i = o.length, a = this.options; r < i; r++)
      n = o[r], V(n, a.draggable, this.el, false) && e.push(n.getAttribute(a.dataIdAttr) || Wn(n));
    return e;
  },
  /**
...
var ot = Xt(function(t, e, n, o) {
  if (e.scroll) {
    ...
    lt !== n && (lt = n, He(), we = e.scroll, d = e.scrollFn, we === true && (we = re(n, true)));
    var c = 0, m = we;
    do {
      var y = m, v = N(y), E = v.top, T = v.bottom, X = v.left, P = v.right, Y = v.width, M = v.height, b = void 0, S = void 0, k = y.scrollWidth, B = y.scrollHeight, A = h2(y), ie = y.scrollLeft, ee = y.scrollTop;
...
var It = "__CLONE__DRAGGABLE__ELEMENT__NODE__";
function zt(...t) {
  var Y, M;
  ...
  function s(b) {
    var S;
    b.item[It] = l(unref((S = unref(o)) == null ? void 0 : S[b.oldIndex]));
  }
  function u(b) {
    const S = b.item[It];
    hn(S) || ($e(b.item), dn(unref(o), b.newIndex, S));
  }
  function d(b) {
  ...
  function v() {
    var B;
    const A = (B = unref(r)) != null ? B : {}, { immediate: b, clone: S } = A, k = Ve(A, ["immediate", "clone"]);
  ...
  }, X = () => T == null ? void 0 : T.option("disabled", true), P = () => T == null ? void 0 : T.option("disabled", false);
  return $n(() => {
    a && E();
...
var Qn = defineComponent({
  ...
  setup(t, { slots: e, emit: n, expose: o }) {
    const r = useAttrs(), i = ut.reduce((d, c) => {
      ...
      const y = toRefs(t), { modelValue: d } = y, c = Ve(y, ["modelValue"]), m = Object.entries(c).reduce((v, [E, T]) => {
        const X = unref(T);
